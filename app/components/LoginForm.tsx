  ...
  return (
    <form onSubmit={handleLogin} className="flex flex-col gap-6">
      <div>
        ...
        <p style={{ margin: "8px 0 0", fontSize: "15px", color: theme.muted }}>Sign in to your {role} account</p>
      </div>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-1.5">
          <div className="flex items-center justify-between">
            ...
            <Link href={`/${role}/forgot-password`} style={{ fontSize: "14px", color: theme.faint }}>
              Forgot password?
            </Link>
          </div>
