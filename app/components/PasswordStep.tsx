...
export default function PasswordStep({
  ...
  role: "mentee" | "mentor";
  tempToken: string;
  onDone: (nextTempToken: string) => void;
  onBack: () => void;
}) {
  const C = theme[role];
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
      <div>
        ...
        <p style={{ margin: "8px 0 0", fontSize: "14px", color: theme.muted }}>You&apos;ll use this to sign in next time.</p>
      </div>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="confirm" style={{ fontSize: "13px", fontWeight: 500, color: theme.muted }}>Confirm password</label>
